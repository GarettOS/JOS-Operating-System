...
env_setup_vm(struct Env *e)
{
    ...
    // Copy all kernel mappings above UTOP and set UPTV
...
load_icode(struct Env *e, uint8_t *binary)
{
    ...
    // Change pgdir from kern to env
    uint32_t prev_cr3 = rcr3();
    lcr3(PADDR(e->env_pgdir));

    // Set headers for loading segments
